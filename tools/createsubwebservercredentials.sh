...
# in ldaps case this is in fact THE MOST IMPORTANT one, should be dns of ldap server
cn = "$webserverdnsname"
...
#subject_unique_id = cafecafecafe02
...
# WARNING DON'T SET path_len if not a ca ( firefox pkix/nss library respect rfc and fails ).
path_len = -1
#path_len = 1
